    ...
    AbstractSelect2 = clazz(Object, {
        ...
        prepareOpts: function (opts) {
            ...
            if (select) {
                opts.query = this.bind(function (query) {
                    ...
                    // do pagination here by zhenglong luo
                    var pageSize = 20;
                    var start= (query.page - 1 ) * pageSize;
                    if (start < data.results.length) {
                        data.more = true;
                        data.results = data.results.slice(start, (query.page) * pageSize);
                    } else {
                        data.results = [];
                    }
        ...
        monitorSource: function () {
            ...
            sync = this.bind(function () {
                ...
                if (display == 'none') this.container.hide();
            ...
            if (el[0].attachEvent) el[0].attachEvent('onpropertychange', sync);
